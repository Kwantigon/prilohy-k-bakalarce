#!/bin/bash
#PBS -N 32k-transformer-example-the-same-copy
#PBS -q gpu
...
this_run_dir=/storage/brno3-cerit/home/kwan/marian-training/using-subword-v01/training-runs/32k-transformer-example-the-same-copy
marian_models_dir=$this_run_dir/models

log_file=$this_run_dir/logs/training-log.txt
train_set_cs=$this_run_dir/data/sentences.tokenized.truecased.bpe.cs
train_set_vi=$this_run_dir/data/sentences.tokenized.truecased.bpe.vi
vocabs_file=$this_run_dir/vocabs/vocab-36k.csvi.yml
valid_set_cs=$this_run_dir/data/newstest2013.tokenized.truecased.bpe.cs
valid_set_vi=$this_run_dir/data/newstest2013.tokenized.truecased.bpe.vi
