...
train_set_cs=$this_run_dir/trainsets/sentences-converted-puncnormalized.tokenized.truecased.bpe.cs
train_set_vi=$this_run_dir/trainsets/sentences-puncnormalized.tokenized.truecased.bpe.vi
vocabs_file=$this_run_dir/vocabs/vocab-36k.csvi.yml
valid_set_cs=$this_run_dir/testset/newstest2013-first1500sentences-puncnormalized.tokenized.truecased.bpe.cs
valid_set_vi=$this_run_dir/testset/newstest2013-first1500sentences-puncnormalized.tokenized.truecased.bpe.vi
